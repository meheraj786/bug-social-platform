      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          (post?.adminId == user?.uid &&
            comment?.commenterId == post?.bloggerId &&
            !editMode) ? (
            <div className="relative">
              {/* Three Dot Button */}
              <button
      ...
      <div className="ml-13 mb-4">
        {editMode ? (
          <textarea
            ...
            className="text-gray-800  w-full text-sm leading-relaxed font-medium whitespace-pre-wrap outline-none border border-gray-300 hover:border-purple-500 rounded-lg"
          >
            {comment.comment}
          </textarea>
        ) : (
