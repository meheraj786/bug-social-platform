      ...
      {friendRequestList.length > 0 && (
        <div className="space-y-4">
          ...
          {friendRequestList.map((user, idx) => (
            <div
              key={idx}
              className="flex items-center justify-between gap-4 p-4 bg-gradient-to-r from-purple-50/80 to-blue-50/80 rounded-2xl border border-purple-200/50 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 group"
            >
