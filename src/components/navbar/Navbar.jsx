                      ...
                      <div className="py-2">
                        ...
                        >
                          <div className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-blue-100 transition-colors duration-200">
                            <BiPlus className="text-base text-gray-600 group-hover:text-blue-600" />
                          </div>
                        ...
                        >
                          <div className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-blue-100 transition-colors duration-200">
                            <FaPagelines className="text-base text-gray-600 group-hover:text-blue-600" />
                          </div>
                          <span className="font-medium">Your Pages</span>
                        </NavLink>
