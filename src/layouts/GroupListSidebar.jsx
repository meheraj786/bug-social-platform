            ...
            >
              <div className="p-2 flex items-center gap-2">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <Link to={`/group-profile/${group.groupId}`}>
                  <button className="text-[12px] bg-gradient-to-r from-purple-500 to-blue-500 text-white px-3 py-1 rounded-full shadow-md hover:scale-100 transition-all font-medium flex items-center gap-1">
                    <Rss className="w-2 h-2" />
                    Post
                  </button>
                  </Link>
                  <Link to={`/messages/groupchat/${group.groupId}`}>
                    <button className="text-[12px] bg-white border border-gray-300 text-gray-600 hover:text-blue-600 px-3 py-1 rounded-full shadow-md hover:scale-105 transition-all font-medium flex items-center gap-1">
          ...
          >
            <div className="p-3 flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="inline-block bg-gradient-to-r from-blue-500 to-purple-500 text-white text-[12px] px-2 py-0.5 rounded-full font-medium mt-1">
                  {group.category}
                </div>
              </div>
                ...
                <div className="flex flex-col gap-1">
                  {!requestedId.includes(group.id) ? (
                    <button
                      ...
                      className="text-[12px] bg-gradient-to-r from-blue-500 to-purple-500 text-white px-3 py-1 rounded-full shadow-md hover:scale-105 transition-all font-medium flex items-center gap-1"
                    >
                      ...
                      className="text-[12px] bg-gradient-to-r from-red-500 to-orange-500 text-white px-3 py-1.5 rounded-full shadow-md hover:scale-105 transition-all font-medium flex items-center gap-1"
                    >
